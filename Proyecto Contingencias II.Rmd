...
# Se cambian los nombres de columnas
...
ggplot(df_personas, aes(x = annos)) +
  ...
  labs(x = "Años", y = "Personas", title = "Hombres por estado en cada año (estados 0 y 1)") +
  scale_colour_manual(name = "Estados",
...
ggplot(df_personas, aes(x = annos)) +
  ...
  labs(x = "Años", y = "Personas", title = "Hombres por estado en cada año (estados 2 al 5)") +
  scale_colour_manual(
    name = "Estados",
    values = c(
      "2" = "tan2",
...
ggplot(df_personas, aes(x = annos)) +
  geom_line(aes(y = est_0, color = "0"), size = 1) +
  geom_line(aes(y = est_1, color = "1"), size = 1) +
  labs(x = "Años", y = "Personas", title = "Mujeres por estado en cada año (estados 0 y 1)") +
  scale_colour_manual(name = "Estados",
                      values = c("0" = "lightpink2",
                                 "1" = "salmon2")) +
  cowplot::theme_cowplot()
...
ggplot(df_personas, aes(x = annos)) +
  ...
  geom_line(aes(y = est_4, color = "4"), size = 1) +
  geom_line(aes(y = est_5, color = "5"), size = 1) +
  labs(x = "Años", y = "Personas", title = "Mujeres por estado en cada año (estados 2 al 5)") +
  scale_colour_manual(
    name = "Estados",
    values = c(
      "2" = "tan2",
...
ggplot(df_comparacion, aes(x = annos)) +
  ...
  labs(x = "Años", y = "Diferencia de personas", title = "Diferencia entre hombres y mujeres") +
  scale_colour_manual(
    name = "Estados",
    values = c(
      "0" = "lightpink2",
...
# Dataframe para gastos e ingresos
df_flujos <-
  data.frame(
...
# Gráfico de gastos, ingresos y resultado neto
ggplot(df_flujos, aes(
  ...
  geom_bar(stat = "identity",
           position = "dodge",
           width = 0.7) +
  labs(x = "Sexo", y = "Valor en 2024 (Miles de millones de colones)", title = "Gastos, Ingresos y flujo neto por sexo") +
