...
ggplot(df_comparacion, aes(x = annos)) +
  geom_line(aes(y = est_0, color = "0"), size = 1) +
  geom_line(aes(y = est_1, color = "1"), size = 1) +
  geom_line(aes(y = est_2, color = "2"), size = 1) +
  geom_line(aes(y = est_3, color = "3"), size = 1) +
  geom_line(aes(y = est_4, color = "4"), size = 1) +
  geom_line(aes(y = est_5, color = "5"), size = 1) +
  geom_hline(
    yintercept = 0,
    linetype = "dashed",
    color = "black",
